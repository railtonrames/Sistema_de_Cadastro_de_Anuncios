...
public class AnuncioDAO {
    ...
    public void cadastrarAnuncio(AnuncioDTO objanunciodto) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "AnuncioDAO|Cadastrar" + erro);
        }
    }
    ...
    public ArrayList<AnuncioDTO> retornaTodos() {
        //Atribui a consulta sql à variável sql.
        String sql = "SELECT ID_ANUNC, NO_ANUNC, NO_CLIENTE, DT_INIC, DT_TERM, VL_INVST_DIA, DATEDIFF(DT_TERM, DT_INIC) * VL_INVST_DIA AS VL_TOTAL FROM TB_ANUNCIO";
        //Conecta ao banco.
        conn = new ConexaoDAO().conector();
    ...
    public ArrayList<AnuncioDTO> retornaRelatorio(String nome, String data1, String data2) {
        ...
        if (!data1.isEmpty() && !data2.isEmpty() && nome.isEmpty()) {
            sql = "SELECT ID_ANUNC, NO_ANUNC, NO_CLIENTE, DT_INIC, DT_TERM, VL_INVST_DIA, DATEDIFF(DT_TERM, DT_INIC) * VL_INVST_DIA AS VL_TOTAL FROM TB_ANUNCIO "
